  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: "Spicery",
        description: "Self-Service Kellner Abrechnung für Spicery",
        theme_color: "#1a1a2e",
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            // index.html / Navigationen: immer zuerst Netzwerk versuchen,
            // damit neue Versionen sofort sichtbar werden.
